...
void home()
{
    ...
    // cleardevice();
    settextstyle(1,0,5);
    outtextxy(300,350,"Welcome ");
    settextstyle(1,0,1);
    setcolor(WHITE);
    outtextxy(510,680,"Bibhu kiju\n Roll no 47");
//settextstyle(2,0,5);
    delay(2000);
//cleardevice();
    midx=getmaxx()/2;
...
void help()
{
    cout<<"I am from help desk"<<endl;

    cout<<"--------------------------------------"<<endl;
    cout<<"Your Available commands"<<endl;

    cout<<"--------------------------------------"<<endl;
    cout<<"commands\t\t functions"<<endl;
    cout<<"ins     \t\t -to insert data in the tree"<<endl;
    cout<<"del     \t\t -to delete data from the tree"<<endl;
    cout<<"root    \t\t -to get the  root data of the tree"<<endl;
